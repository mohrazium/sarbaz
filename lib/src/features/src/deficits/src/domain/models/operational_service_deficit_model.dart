...
class OperationalServiceDeficitRecordModel {
  ...
  factory OperationalServiceDeficitRecordModel.fromJson(Map<String, dynamic> json) =>
      _$OperationalServiceDeficitRecordModelFromJson(json);
  Map<String, dynamic> toJson() => _$OperationalServiceDeficitRecordModelToJson(this);
