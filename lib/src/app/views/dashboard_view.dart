...
class DashboardDesktopView extends GetView<DashboardController> {
  ...
  Widget buildBodyContent({Function()? onPressedMenu}) {
    ...
    return GetX(
        ...
        builder: (_) {
          return IndexedStack(
            index: controller.dashboardShownContentIndex.value,
            children: [
              Padding(
                        ...
                        Expanded(
                          child: SearchField(
                            ...
                            hintText: Strings.searchBar +
                                controller.dashboardShownContentIndex.value
                                    .toString(),
                          ),
                        ),
                      ],
              ...
              const Expanded(child: SoldiersView())
            ],
          );
        });
  }
