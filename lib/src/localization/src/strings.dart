...
class Strings {
  ...
  static const String vacationRecords = "سوابق مرخصی";
  ...
  static const String nationalIdentity = " شماره شناسنامه";
  ...
  static const String unsuccessfullySavingInfo = "ذخیره ی اطلاعات با مشکل مواجه شد";

  static const String successfullyUpdatingInfo = "اطلاعات با موفقیت ویرایش شد";

  static const String unsuccessfullyUpdatingInfo = "ویرایش اطلاعات با مشکل مواجه شد";
  ...
  static const String dateOfMarriageIsNotBeforeTody = "تاریخ عقد نامعتبر است,تاریخ باید قبل از امروز باشد";
  ...
  static List<String> caseStatusList = [caseStatusAvailable, caseStatusArchived, caseStatusWipedOut];
  ...
  static const String soldierStatusIntroductionToCommission = "معرفی به کمیسیون";
  ...
  static const String dispatcher = "حوزه اعزام کننده";
  ...
  static const String eligibleVacationTotal = "کل مرخصی استحقاقی";

  static const String eligibleVacationBalance = "مانده مرخصی استحقاقی";
  ...
  static const String sickVacationTotal = "کل استعلاجی";

  static const String sickVacationBalance = "مانده استعلاجی";
  ...
  static const String incentiveVacationBalance = "مانده مرخصی تشویقی";
