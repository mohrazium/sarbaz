...
class FurtherInfoController extends GetxController with ValidatorMixin, DateConverterMixin {
  ...
  final BaseController _bridgeController;
  ...
  void onCalenderPressed(context) async {
    ...
    if (picked != null) {
      dateOfMarriageController.text = convertEnToFa(picked.formatCompactDate());
    }
  }
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (BuildContext context) {
        return Strings.bloodTypeList.map<PopupMenuItem<String>>((String value) {
          return PopupMenuItem(value: value, child: SizedBox(width: kTextFieldWidth / 5, child: Text(value)));
        }).toList();
      },
    );
  }
