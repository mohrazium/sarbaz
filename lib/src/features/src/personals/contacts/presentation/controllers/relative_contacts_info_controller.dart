...
import '../../../../dashboard/presentation/presentation.dart';
...
class RelativeContactsInfoController extends GetxController
  ...
  RelativeContactsInfoController(this._baseController, this.contactController, this._relativeContactsService);
                ...
                onYesPressed: () {
                  ...
                  if (model.value.id == null &&
                    ...
                    if (!isEditorOpen.value) {
                      mdiController.closeWindow(mdiEditorId);//TODO : move mdiController to base controller
                    }
