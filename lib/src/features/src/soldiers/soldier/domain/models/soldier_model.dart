...
import '../../../../casenos/domain.dart';
import '../../../../unit/domain.dart';
import '../../../heathy/domain.dart';
import '../../../trainings/domain.dart';
import 'soldier_case_model.dart';
...
class SoldierModel {
  ...
  factory SoldierModel.init() =>
      SoldierModel(caseStatus: "", divisionStatus: false, isArchived: false, caseNo: CaseNoModel.init());
