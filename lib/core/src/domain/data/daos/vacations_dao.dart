...
class VacationsDAO extends DatabaseAccessor<SoldierDatabase>
  ...
  Future<VacationsTableData> doInsert(
      Map<String, dynamic> entry, int soldierCaseId) async {
    final data = VacationsTableData.fromJson(entry);
    final result = await into(vacationsTable).insertReturning(
    ...
    customUpdate(
      ...
      variables: [
        ...
        Variable.withInt(soldierCaseId)
      ],
    );
    return result;
  }
