...
import 'daily_absence_overtime_model.dart';
import 'violations_overtime_model.dart';
part 'disciplinary_overtime_model.g.dart';
...
class DisciplinaryOvertimeModel {
  ...
  factory DisciplinaryOvertimeModel.fromJson(Map<String, dynamic> json) => _$DisciplinaryOvertimeModelFromJson(json);
